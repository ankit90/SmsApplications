...
public class publisher extends HttpServlet {
    ...
    String getresult(String txtWebMsg, String txtmob, String txtagg,String para,String abs) {
        ...
        try{
            ...
            String author="";
            String keyword="";
            String pub=URLEncoder.encode(input[0],"utf-8");
            if(input.length==2)
            keyword=URLEncoder.encode(input[1],"utf-8");
            else
            keyword="";
            String url="http://scholar.google.com/scholar?as_q="+keyword+"&num=20&btnG=Search+Scholar&as_epq=&as_oq=&as_eq=&as_occt=any&as_sauthors="+author+"&as_publication="+pub+"&as_ylo=&as_yhi=&as_sdt=1.&as_sdtp=on&as_sdtf=&as_sdts=5&hl=en";
                ...
                if(para!=null)
            {
                ...
                result=result+"<br></br>";
                result=result+"<a href=\"http://www.tomar-scholar.appspot.com/publisher?txtweb-message="+txtweb+"&no="+pa+"\"  class=\"txtweb-menu-for\">Next Result</a><br></br>";
                result=result+"<a href=\"http://www.tomar-scholar.appspot.com/publisher?txtweb-message="+txtweb+"&no="+pa1+"\"  class=\"txtweb-menu-for\">Back to Same Result</a><br></br>";
            ...
            {
                result=result+"<br></br>";
                result=result+"<a href=\"http://www.tomar-scholar.appspot.com/publisher?txtweb-message="+txtweb+"&no=1\" class=\"txtweb-menu-for\" >Next Result</a><br></br>";
                result=result+"<a href=\"http://www.tomar-scholar.appspot.com/publisher?txtweb-message="+txtweb+"\" class=\"txtweb-menu-for\" >Back to Same Result</a><br></br>";
            ...
            StartTag st6=e.getFirstStartTag("font");
            if(st6!=null)
            {
            Element e5=st6.getElement();
            ...
            if(para!=null)
            {
                ...
                result=result+"<br></br>";
                result=result+"<a href=\"http://www.tomar-scholar.appspot.com/publisher?txtweb-message="+txtweb+"&no="+pa+"\"  class=\"txtweb-menu-for\">Next Result</a><br></br>";
                result=result+"<a href=\"http://www.tomar-scholar.appspot.com/publisher?txtweb-message="+txtweb+"&no="+pa1+"&abs=true\" class=\"txtweb-menu-for\">Search Abstract</a>";
            ...
            else
            {
                result=result+"<br></br>";
                result=result+"<a href=\"http://www.tomar-scholar.appspot.com/publisher?txtweb-message="+txtweb+"&no=1\" class=\"txtweb-menu-for\" >Next Result</a><br></br>";
                result=result+"<a href=\"http://www.tomar-scholar.appspot.com/publisher?txtweb-message="+txtweb+"&abs=true\" class=\"txtweb-menu-for\" >Search Abstract</a>";
            }
