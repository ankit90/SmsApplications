    ...
    String getresult(String txtWebMsg, String txtmob, String txtagg,String para,String abs) {
        ...
        try{
                ...
                if(para!=null)
            {
                ...
                result=result+"<br></br>";
                result=result+"<a href=\"http://www.tomar-scholar.appspot.com/author?txtweb-message="+txtweb+"&no="+pa+"\"  class=\"txtweb-menu-for\">Next Result</a><br></br>";
                result=result+"<a href=\"http://www.tomar-scholar.appspot.com/author?txtweb-message="+txtweb+"&no="+pa1+"\"  class=\"txtweb-menu-for\">Back to Same Result</a><br></br>";
            ...
            {
                result=result+"<br></br>";
                result=result+"<a href=\"http://www.tomar-scholar.appspot.com/author?txtweb-message="+txtweb+"&no=1\" class=\"txtweb-menu-for\" >Next Result</a><br></br>";
                result=result+"<a href=\"http://www.tomar-scholar.appspot.com/author?txtweb-message="+txtweb+"\" class=\"txtweb-menu-for\" >Back to Same Result</a><br></br>";
            ...
            if(para!=null)
            {
                ...
                result=result+"<br></br>";
                result=result+"<a href=\"http://www.tomar-scholar.appspot.com/author?txtweb-message="+txtweb+"&no="+pa+"\"  class=\"txtweb-menu-for\">Next Result</a><br></br>";
                result=result+"<a href=\"http://www.tomar-scholar.appspot.com/author?txtweb-message="+txtweb+"&no="+pa1+"&abs=true\" class=\"txtweb-menu-for\">Search Abstract</a>";
            ...
            else
            {
                result=result+"<br></br>";
                result=result+"<a href=\"http://www.tomar-scholar.appspot.com/author?txtweb-message="+txtweb+"&no=1\" class=\"txtweb-menu-for\" >Next Result</a><br></br>";
                result=result+"<a href=\"http://www.tomar-scholar.appspot.com/author?txtweb-message="+txtweb+"&abs=true\" class=\"txtweb-menu-for\" >Search Abstract</a>";
            }
